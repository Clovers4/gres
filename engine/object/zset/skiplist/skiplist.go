...
func newNode(level int, score float64, val string) *SkiplistNode {
	return &SkiplistNode{
		score:  score,
		val:    val,
...
func (n *SkiplistNode) Score() float64 {
	return n.score
}
...
func (sl *Skiplist) Insert(score float64, val string) *SkiplistNode {
...
func (sl *Skiplist) Delete(score float64, val string) {
	update := make([]*SkiplistNode, MaxLevel, MaxLevel)
...
// 注意 val==n.val
func (sl *Skiplist) UpdateScore(curScore, newScore float64, val string) *SkiplistNode {
	update := make([]*SkiplistNode, MaxLevel, MaxLevel)
